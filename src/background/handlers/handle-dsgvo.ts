import { evaluateArt13_14, evaluateArt25, evaluateArt7 } from "@/data/dsgvo/evaluate";
import { type ConsentTimingResult, type ContentScriptDsgvoResult, type DsgvoResult } from "@/utils/types/dsgvo-types";
...
export function handleDsgvo({
  ...
  const result: DsgvoResult = {
    ...
    art25: evaluateArt25(
      ...
      trackers,
      contentResult.art25.fingerprintingDetected || (clientHintsDetected ?? false),
    ),
    checkedAt: Date.now(),
  };
