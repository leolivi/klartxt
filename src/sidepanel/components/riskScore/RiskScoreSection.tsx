...
export function RiskScoreSection() {
  ...
  return (
    <div className="flex gap-8 items-center p-4">
      <div
        className={`rounded-full bg-surface-secondary dark:bg-surface-secondary border-6 border-surface-tertiary relative size-24 shrink-0 flex justify-center items-center ${colors}`}
      >
        <svg
        ...
        <div className="flex flex-col items-center">
          <p className="text-[28px] font-semibold text-inherit border-ink-default/80 border-b-2">
            {score}
          </p>
      ...
      <div className="text-left">
        <p className="text-h3 pb-2 text-ink-strongest">
