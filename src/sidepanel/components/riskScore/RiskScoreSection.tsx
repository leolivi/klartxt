  ...
  return (
    <>
      <div className="flex gap-8 items-center p-4">
        <div className={`rounded-full bg-surface-secondary border-6 border-surface-tertiary relative size-24 shrink-0 flex justify-center items-center ${colors}`}>
          ...
          <p className="text-h1">{score}<span className="text-body text-ink-default">/5</span></p>
          <RiskScoreDialog/>
        </div>
