...
export function HeroBanner() {
  ...
  return (
    <div className="hero-gradient sm:min-h-[600px] min-h-[200px] w-full flex flex-col items-center justify-center p-8">
      <Card
        className={`logo-spin-3d${animateOnLoad ? " logo-spin-3d--animate" : ""} bg-primary shadow-xl size-20 sm:size-40 border-none flex justify-center items-center`}
